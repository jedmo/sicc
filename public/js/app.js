...
/* harmony import */ var _charts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./charts */ "./resources/js/charts.js");
/* harmony import */ var _charts__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_charts__WEBPACK_IMPORTED_MODULE_2__);
...
$("#select-municipality").select2({
  placeholder: "Seleccione un distrito municipal...",
  dropdownCssClass: "option2",
  allowClear: !0
});
$(document).ready(function () {
  ...
  function updateTotalAdult() {
    var siblingAValue = parseInt($('#adult_sibling_attendance').val()) || 0;
    var friendsAValue = parseInt($('#adult_friends_attendance').val()) || 0;
  ...
  function updateTotalYouth() {
    var siblingYValue = parseInt($('#youth_sibling_attendance').val()) || 0;
    var friendsYValue = parseInt($('#youth_friends_attendance').val()) || 0;
  ...
  function updateTotalChildren() {
    var siblingCValue = parseInt($('#children_sibling_attendance').val()) || 0;
    var friendsCValue = parseInt($('#children_friends_attendance').val()) || 0;
  ...
  function updateTotalD1() {
    var siblingAttD1 = parseInt($('#sibling_attendance_1d').val()) || 0;
    var friendsAttD1 = parseInt($('#friends_attendance_1d').val()) || 0;
  ...
  function updateTotalD2() {
    var siblingAttD2 = parseInt($('#sibling_attendance_2d').val()) || 0;
    var friendsAttD2 = parseInt($('#friends_attendance_2d').val()) || 0;
  ...
  function updateTotalSD() {
    var siblingAttSd = parseInt($('#sibling_attendance_sd').val()) || 0;
    var friendsAttSd = parseInt($('#friends_attendance_sd').val()) || 0;
  ...
  $('#select-cell').on('change', function () {
    axios.get("/cell_members/list" + $(this).val(), {
      ...
      $.each(rd.data, function (key, value) {
        var html = '<tr>' + '<td class="pe-0"><div class="d-flex"><div class="userDatatable__imgWrapper d-flex align-items-center m-0"><div class="checkbox-group-wrapper">' + '<div class="checkbox-group d-flex"><div class="checkbox-theme-default custom-checkbox checkbox-group__single d-flex">' + '<input class="checkbox" type="checkbox" id="check-grp-' + value.id + '" name="attendance[]" value="' + value.id + '">' + '<label for="check-grp-' + value.id + '" class="ps-0"></label></div></div></div></div></div></td>' + '<td><div class="userDatatable-content d-inline-block"><span>' + value.member_name + '</span></div></td>' + '<td><div class="userDatatable-content d-inline-block"><span>' + value.member_age + '</span></div></td>' + '</tr>';
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _setup_image_preview_field__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./setup_image_preview_field */ "./resources/js/form/setup_image_preview_field.js");
...
/***/ "./resources/js/form/setup_clear_input_file_field.js":
/*!***********************************************************!*\
  !*** ./resources/js/form/setup_clear_input_file_field.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/form/setup_image_preview_field.js":
/*!********************************************************!*\
  !*** ./resources/js/form/setup_image_preview_field.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
