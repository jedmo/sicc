    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="d-flex align-items-center user-member__title mb-30 mt-30">
                <h4 class="text-capitalize">Editar asistencia a reunión de supervisión</h4>
            </div>
        </div>
    </div>
    @if(session('status'))
            ...
            <div class="row justify-content-center">
                <div class="col-sm-10 col-10">
                    <div class="mt-40 mb-50">
                        <form action="{{ route('supervision-attendances.update', $supervision_attendance->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
