                                    ...
                                    <div class="checkbox-group-wrapper">
                                        <div class="checkbox-group d-flex">
                                            <div class="checkbox-theme-default custom-checkbox checkbox-group__single d-flex">
                                                <input class="checkbox" type="checkbox" id="check-grp-{{ $member->id }}" name="attendance[]" value="{{ $member->id }}" {{  $cell_attendance->exists && in_array($member->id, $cell_attendance->member_attendance) ? 'checked' : '' }}>
