            ...
            <div class="col-lg-12 mb-30">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="GET">
                            <div class="row">
                                @hasanyrole('Pastor General|Administrador')
                                <div class="col-md-4">
                                    <select class="form-control ih-medium ip-gray radius-xs b-light px-15" name="district_id" id="district_id">
                                ...
                                @endhasanyrole
                                @hasrole('Pastor de Distrito')
                                <div class="col-md-2">
                                    <h5>{{ $districts['full_code'] }}</h5>
                                </div>
                                @endhasrole
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4 dm-button-list d-flex flex-wrap">
                                    ...
                                    @if ($district_id)
                                        <div class="action-btn mt-sm-0 mt-15">
                                            <a href="{{ route('reports.districts') }}" class="btn btn-info btn-default btn-rounded" style="margin: 5px 6px">
                                                Quitar filtro
                                            </a>
                                        </div>
                                    @endif
