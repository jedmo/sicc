<div class="row">
        ...
        <div class="col-md-6 mb-25">
            ...
            <select class="form-control ih-medium ip-gray radius-xs b-light px-15" name="cell_id" id="cell_id" required>
                ...
                <option value="{{ $cell['id'] }}" {{ $cellMember->cell_id == $cell['id'] ? 'selected' : '' }}>
                    {{ $cell['full_code'] }}
                </option>
                @endforeach
            </select>
    ...
    <div class="col-md-6 mb-25">
        ...
        <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="first_name"
            value="{{ $cellMember->first_name }}" id="first_name" placeholder="primer nombre" required>
    ...
    <div class="col-md-6 mb-25">
        ...
        <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="second_name"
            value="{{ $cellMember->second_name }}" id="second_name" placeholder="segundo nombre">
    ...
    <div class="col-md-6 mb-25">
        ...
        <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="third_name"
            value="{{ $cellMember->third_name }}" id="third_name" placeholder="tercer nombre">
    ...
    <div class="col-md-6 mb-25">
        ...
        <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="first_surname"
            value="{{ $cellMember->first_surname }}" id="first_surname" placeholder="primer apellido" required>
    ...
    <div class="col-md-6 mb-25">
        ...
        <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="second_surname"
            value="{{ $cellMember->second_surname }}" id="second_surname" placeholder="segundo apellido">
    ...
    <div class="col-md-6 mb-25">
        ...
        <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="third_surname"
            value="{{ $cellMember->third_surname }}" id="third_surname" placeholder="apellido de casada">
    ...
    <div class="col-md-6 mb-25">
        ...
        <select class="form-control ih-medium ip-gray radius-xs b-light px-15" name="sex" id="sex">
            <option value="">Seleccione</option>
            <option value="masculino" {{ $cellMember->sex == 'masculino' ? 'selected' : '' }}>Masculino</option>
            <option value="femenino" {{ $cellMember->sex == 'femenino' ? 'selected' : '' }}>Femenino</option>
        </select>
        @if ($errors->has('sex'))
    ...
    <div class="form-group-calender col-md-6 mb-25">
        <div class="with-icon">
            ...
            <div class="position-relative">
                ...
                value="{{ $cellMember->birth_date ? date('d/m/Y', strtotime($cellMember->birth_date)) : '' }}" placeholder="dd/mm/aaaa">
    ...
    <div class="col-md-6 mb-25">
        ...
        <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="address"
            value="{{ $cellMember->member->address->address }}" id="address" placeholder="residencial / colonia / barrio">
    ...
    <div class="col-md-6 mb-25">
        ...
        <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="street"
            value="{{ $cellMember->member->address->street }}" id="street" placeholder="pasaje / calle / avenida / otros">
    ...
    <div class="col-md-6 mb-25">
        ...
        <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="house_num"
            value="{{ $cellMember->member->address->house_num }}" id="house_num" placeholder="num. casa / apartamento">
    ...
    <div class="col-md-6 mb-25">
        ...
        <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="canton"
            value="{{ $cellMember->member->address->canton }}" id="address" placeholder="cantón">
    ...
    <div class="col-md-6 mb-25">
        ...
        <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="hamlet"
            value="{{ $cellMember->member->address->hamlet }}" id="hamlet" placeholder="caserío">
    ...
    <div class="col-md-6 mb-25">
        ...
        <select class="form-control ih-medium ip-gray radius-xs b-light px-15" name="municipal_district_id" id="select-municipality" required>
            ...
            @foreach ($municipalities as $municipality)
                <option value="{{ $municipality['id'] }}" {{ $cellMember->member->address->municipal_district_id == $municipality['id'] ? 'selected' : '' }}>{{ $municipality['name'] }}</option>
            @endforeach
        </select>
    ...
    <div class="col-md-6 mb-25">
        ...
        <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="cellphone"
            value="{{ $cellMember->cellphone }}" id="cellphone" placeholder="célular">
    ...
    <div class="col-md-6 mb-25">
        ...
        <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="phone"
            value="{{ $cellMember->phone }}" id="phone" placeholder="teléfono">
        @if($errors->has('phone'))
    ...
    <div class="col-md-6 mb-25">
        ...
        <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="dui"
            value="{{ $cellMember->dui }}" id="dui" placeholder="dui">
        @if($errors->has('dui'))
    ...
    <div class="col-md-6 mb-25">
        ...
        <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="nit"
            value="{{ $cellMember->nit }}" id="nit" placeholder="nit">
        @if($errors->has('nit'))
    ...
    <div class="col-md-6 mb-25">
        ...
        <select class="form-control ih-medium ip-gray radius-xs b-light px-15" name="marital_status" id="marital_status">
            <option value="1" {{ $cellMember->marital_status == 1 ? 'selected' : '' }}>Soltero/a</option>
            <option value="2" {{ $cellMember->marital_status == 2 ? 'selected' : '' }}>Casado/a</option>
            <option value="3" {{ $cellMember->marital_status == 3 ? 'selected' : '' }}>Divorsiado/a</option>
            <option value="4" {{ $cellMember->marital_status == 4 ? 'selected' : '' }}>Acompañado/a</option>
            <option value="5" {{ $cellMember->marital_status == 5 ? 'selected' : '' }}>Viudo/a</option>
        </select>
    ...
    <div class="col-md-6 mb-25">
        ...
        <select class="form-control ih-medium ip-gray radius-xs b-light px-15" name="marital_status" id="marital_status">
            <option value="">Seleccione</option>
            <option value="1" {{ $cellMember->blood_type == 1 ? 'selected' : '' }}>ARH+</option>
            <option value="2" {{ $cellMember->blood_type == 2 ? 'selected' : '' }}>ARH-</option>
            <option value="3" {{ $cellMember->blood_type == 3 ? 'selected' : '' }}>BRH+</option>
            <option value="4" {{ $cellMember->blood_type == 4 ? 'selected' : '' }}>BRH-</option>
            <option value="5" {{ $cellMember->blood_type == 5 ? 'selected' : '' }}>ABRH+</option>
            <option value="6" {{ $cellMember->blood_type == 6 ? 'selected' : '' }}>ABRH-</option>
            <option value="7" {{ $cellMember->blood_type == 7 ? 'selected' : '' }}>ORH+</option>
            <option value="8" {{ $cellMember->blood_type == 8 ? 'selected' : '' }}>ORH-</option>
        </select>
        @if ($errors->has('marital_status'))
        <p class="text-danger">{{ $errors->first('marital_status') }}</p>
        @endif
    ...
    <div class="col-md-6 mb-25">
        ...
        <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="occupation"
            value="{{ $cellMember->occupation }}" id="occupation" placeholder="profesión u oficio">
    ...
    <div class="col-md-6 mb-25">
        ...
        <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="email"
            value="{{ $cellMember->email }}" id="email" placeholder="correo electrónico">
        @if($errors->has('email'))
    ...
    <div class="form-group-calender col-md-6 mb-25">
        <div class="with-icon">
            ...
            <div class="position-relative">
                ...
                value="{{ $cellMember->conversion_date ? date('d/m/Y', strtotime($cellMember->conversion_date)) :  '' }}" placeholder="dd/mm/aaaa">
                <a href="#"><img class="svg" src="{{ asset('assets/img/svg/calendar.svg') }}" alt="calendar"></a>
            </div>
        </div>
    </div>
    <div class="col-md-6 mb-25">
        ...
        <select class="form-control ih-medium ip-gray radius-xs b-light px-15" name="status" id="status">
            <option value="1" {{ $cellMember->status == 1 ? 'selected' : '' }}>Activo</option>
            <option value="0" {{ $cellMember->status == 0 ? 'selected' : '' }}>Inactivo</option>
        </select>
